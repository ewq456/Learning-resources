...
> 音视频开发是嵌入式领域的高薪方向之一，主要涉及编解码、流媒体、传输协议。

---

## 🎬 FFmpeg — 音视频处理的核心工具

FFmpeg 是音视频处理的"瑞士军刀"，几乎支持所有格式的编解码、转封装、流化。

### 编译

| 资料 | 路径 |
|------|------|
| Linux下编译ffmpeg库 | > **编译ffmpeg**
...
--- |
| ffmpeg文档 | [ffmpeg-doc.chm](../../My/C++/ffmpeg-doc.chm) |
...
| 资料 | 路径 |
|------|------|
| 零声科技培训合同 | [培训合同-音视频](../../My/音视频/湖南零声信息科技有限公司技术培训服务合同书 - （正式版） - 音视频.pdf) |
| 音视频笔记 | > **音视频笔记**
...
1. **FFmpeg命令行使用** → 理解编解码流程
2. **FFmpeg API编程** → 用C/C++调用FFmpeg
3. **音视频编码原理** → H.264/H.265/AAC
4. **流媒体协议** → RTMP/HLS/WebRTC
5. **项目实战** → 播放器/推流器/转码工具
